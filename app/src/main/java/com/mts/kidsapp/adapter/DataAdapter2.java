...
import com.mts.kidsapp.activities.PlayVideoActivity2;
...
public class DataAdapter2 extends RecyclerView.Adapter<DataAdapter2.ViewHolder> {
    ...
    public DataAdapter2(Activity investActivity, ArrayList<Object> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.ivIcon.setOnClickListener(view -> {
            ...
            mp.setOnCompletionListener(mp1 -> {
                ...
                Intent intent = new Intent(context, PlayVideoActivity2.class);
